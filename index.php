...
<body class="home">
        ...
        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/logo1.png" alt="logo"> </a>
        ...
        <section class="hero bg-image" style="opacity: 95%;" data-image-src="images/img/harap1.png">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Food Order and Delivery</h1>
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span style="color:white">1. </span>Choose a Food Shop</h4> </div>
                        ...
                        <div class="step-item step2">
                            ...
                            <h4><span style="color:white;">2. </span>Order a Food</h4> </div>
                        ...
                        <div class="step-item step3">
                            ...
                            <h4><span style="color:white;">3. </span>Delivery to Take out</h4> </div>
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <h3>Choose a Shop</h3>
                                    <p>We"ve got your covered with menus from a variety of Foods online.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <h3>Choose a dish</h3>
                                <p>We"ve got your covered with a variety of delivery Food Shop online.</p>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="title-block pull-left">
                            <h4>Featured Shop</h4> </div>
                    </div>
                    <div class="col-sm-8">
                        <div class="shop-filter pull-right">
														...
														<div class="shop-wrap">
															<div class="row">
																<div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
																	<a class="shop-logo" href="dishes.php?res_id='.$rows['rs_id'].'" > <img src="admin/Res_img/'.$rows['image'].'" alt="Shop logo"> </a>
																</div>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p>174, Jb Pascual Street Cabugao Sto.Domingo Nueva Ecija</p>
                                    <h5></a></h5> </div>
                                <div class="col-xs-12 col-sm-5 additional-info color-gray">
                                    <h5>Addition informations</h5>
                                   <p>Join thousands of other shop who benefit from having partnered with us.</p>
                                </div>
                    </div>
                </div>
            </div>
